...
namespace KalynaCipher.KalynaSharp.Model
{
    ...
    {
        public static byte[,] mds_matrix { get; set; } = {
        ...
        public static byte[,] mds_inv_matrix { get; set; } = {
        ...
        public static byte[,] sboxes_enc { get; set; } = {
        {
        ...
        public static byte[,] sboxes_dec { get; set; } = {
        {
